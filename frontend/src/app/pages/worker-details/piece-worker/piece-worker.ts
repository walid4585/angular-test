...
@Component({
  selector: 'app-piece-worker',
  imports: [CommonModule],
  templateUrl: './piece-worker.html',
  styleUrl: './piece-worker.css',
})
export class PieceWorker implements OnInit {
...
loadProduction(): void {
    ...
    this.workerProductionService
        ...
        .getWorkerProduction(worker.id)

        .subscribe({

            next: (rows) => {

                this.production.set(rows);
